...
import 'package:midika/Screens/qr_screen/range_qr_screen.dart';
...
class CreateQRCodeScreen extends StatefulWidget {
  ...
  CreateQRCodeScreen({this.qr_model, this.edit_mode = false});
...
class _CreateQRCodeScreenState extends State<CreateQRCodeScreen> {
  ...
  getCurrentUser() {
    ...
    if (widget.edit_mode == true) {
      qr_id = widget.qr_model!.qrCodeId;

      _tableNumberController.text = widget.qr_model!.tableNo.toString();
    }
  }
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context,
                      ...
                      return RangeQrScreen();
                    }));
                  },
                  child: Tooltip(
                    message: txtGenerateRangeOfQrcode,
                    child: Icon(
                      Icons.add,
                      color: Colors.black,
                    ),
                    ...
                    children: [
                      ...
                      WidgetToImage(
                        builder: (key) {
                          _globalKey = key;
                          return QrImage(
                            data: _tableNumberController.text.toString() +
                                '?' +
                        ...
                        onTap: () async {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            await provider.saveQrCodeToFirebase(
                              ...
                              context: context,
                              table_no: int.parse(
                                _tableNumberController.text.toString(),
                              ),
                              edit_mode: widget.edit_mode!,
                              qr_code_id: qr_id!,
                            );
                            Utils.downloadImage(
                                fileName: "Qr_${_tableNumberController.text}",
